...
/*   Updated: 2025/07/21 12:18:20 by maheleni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*		Returns:
*			a character.
* @returns The string created from the successive applications of ’f’ New empty
* string if s is empty NULL if the allocation fails
*/
